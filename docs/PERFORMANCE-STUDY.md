...
| 9 | Is the garbage collector part of the tail, and is generational better here? **Answered 2026-08-16 — stopping the collector entirely buys 3.5%; generational is 2.5% faster and cuts p99 from 7.50ms to 5.66ms.** |
